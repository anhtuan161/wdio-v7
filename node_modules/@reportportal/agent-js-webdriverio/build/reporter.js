...
class Reporter extends reporter_1.default {
    ...
    finishTest(testStats) {
        ...
        const finishTestItemRQ = Object.assign(Object.assign(Object.assign({ status: testStats.state }, (attributes && { attributes })), (description && { description })), (status && { status }));
    ...
    onSuiteEnd() {
        ...
        const finishTestItemData = Object.assign(Object.assign(Object.assign({}, (status && { status })), (attributes && { attributes })), (description && { description }));
